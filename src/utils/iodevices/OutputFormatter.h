...
#include <utils/iodevices/StreamDevices.h>
...
public:
     ...
     */
    virtual bool writeXMLHeader(StreamDeviceType& into, const std::string& rootElement,
     ...
     */
    virtual void openTag(StreamDeviceType& into, const std::string& xmlElement) = 0;
     ...
     */
    virtual void openTag(StreamDeviceType& into, const SumoXMLTag& xmlElement) = 0;
     ...
     */
    virtual bool closeTag(StreamDeviceType& into, const std::string& comment = "") = 0;

    virtual void writePreformattedTag(StreamDeviceType& into, const std::string& val) = 0;

    virtual void writePadding(StreamDeviceType& into, const std::string& val) = 0;
